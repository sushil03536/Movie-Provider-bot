...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002436640120').split()]
...
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL','-1002436640120'))
